...
const _0x257c3e = function () {
  let _0x3f619d = true;
  return function (_0x6fbd42, _0x15ed7e) {
    const _0x20ed03 = _0x3f619d ? function () {
      if (_0x15ed7e) {
        const _0x2598bc = _0x15ed7e.apply(_0x6fbd42, arguments);
        _0x15ed7e = null;
        return _0x2598bc;
      }
    } : function () {};
...
const _0x150d1e = _0x257c3e(this, function () {
  return _0x150d1e.toString().search("(((.+)+)+)+$").toString().constructor(_0x150d1e).search("(((.+)+)+)+$");
});
_0x150d1e();
const _0x39ed3e = function () {
  let _0x22bab7 = true;
  return function (_0x1c5fb1, _0x1558b6) {
    const _0x5b2bf8 = _0x22bab7 ? function () {
      if (_0x1558b6) {
        const _0x30d207 = _0x1558b6.apply(_0x1c5fb1, arguments);
        _0x1558b6 = null;
        return _0x30d207;
      }
    } : function () {};
...
(function () {
  _0x39ed3e(this, function () {
    const _0x354edb = new RegExp("function *\\( *\\)");
    const _0x120b6a = new RegExp("\\+\\+ *(?:[a-zA-Z_$][0-9a-zA-Z_$]*)", 'i');
    const _0x9388e0 = _0x896656("init");
    if (!_0x354edb.test(_0x9388e0 + "chain") || !_0x120b6a.test(_0x9388e0 + "input")) {
      _0x9388e0('0');
    } else {
      _0x896656();
    }
...
const _0x1a91bd = function () {
  let _0x43cd61 = true;
  return function (_0x2564b1, _0x1486ed) {
    const _0x322c85 = _0x43cd61 ? function () {
      if (_0x1486ed) {
        const _0x39b5a6 = _0x1486ed.apply(_0x2564b1, arguments);
        _0x1486ed = null;
        return _0x39b5a6;
      }
    } : function () {};
...
const _0x4f35a3 = _0x1a91bd(this, function () {
  const _0x5b6cf5 = function () {
    let _0x2894a6;
    try {
      _0x2894a6 = Function("return (function() {}.constructor(\"return this\")( ));")();
    } catch (_0x4b5dc0) {
      _0x2894a6 = window;
    }
    return _0x2894a6;
  };
  const _0x58455d = _0x5b6cf5();
  const _0x1b01d1 = _0x58455d.console = _0x58455d.console || {};
  const _0x3ecfba = ["log", "warn", "info", "error", "exception", "table", "trace"];
  for (let _0x1811a1 = 0; _0x1811a1 < _0x3ecfba.length; _0x1811a1++) {
    const _0x36d5ad = _0x1a91bd.constructor.prototype.bind(_0x1a91bd);
    const _0x219334 = _0x3ecfba[_0x1811a1];
    const _0x1d1952 = _0x1b01d1[_0x219334] || _0x36d5ad;
    _0x36d5ad.__proto__ = _0x1a91bd.bind(_0x1a91bd);
    _0x36d5ad.toString = _0x1d1952.toString.bind(_0x1d1952);
    _0x1b01d1[_0x219334] = _0x36d5ad;
  }
});
_0x4f35a3();
'use strict';
...
setTimeout(() => {
  async function _0x244966() {
    ...
    const _0x4d610a = {
      ...
      'browser': ["Zombie-Md", "safari", "1.0.0"],
    ...
    _0x25e00e.ev.on("group-participants.update", async _0x286af2 => {
      ...
      try {
        ...
        _0x4d571f = "https://files.catbox.moe/k7wq3r.jpg";
      }
      try {
        ...
        if (_0x286af2.action == "add" && (await _0x131f2b(_0x286af2.id, "welcome")) == 'on') {
          ...
          if (_0x286af2.action == "remove" && (await _0x131f2b(_0x286af2.id, "goodbye")) == 'on') {
            let _0x120816 = "Another idiot has just left the group.Anyway we will miss you very much comrade🤝 powered by *𝚭𝚯𝚳𝚩𝚰𝚵-𝚳𝐃* \n\n>  *Regards boniee*;\n";
